...
RUN apt-get update
RUN apt-get install -y subversion cmake help2man wget curl python3 python3-distutils file rsync build-essential gnupg gawk unzip ncurses-dev git qemu-utils
RUN apt-get update
